...
// 👇 AICI ERA PROBLEMA: Trebuie să aibă "export" în față!
export interface Task {
  id: string;
  text: string;
  category: string;
  completed: boolean;
  deadline?: string; // semnul întrebării înseamnă că e opțional
  createdAt?: string; // <--- ADAUGĂ ACEASTĂ LINIE
  uid?: string;       // <--- Asigură-te că și asta există
}
